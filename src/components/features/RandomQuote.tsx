      ...
      <div className="flex flex-col h-full">
        <div className="flex items-center justify-between gap-2.5 mb-4">
          <div className="flex items-center gap-2.5">
            <Quote className="text-lg text-neutral-800 dark:text-neutral-100/70" size={18} />
            <p className="text-sm text-neutral-800 dark:text-neutral-100/70">{t('quotes.md')}</p>
          </div>
        ...
        <div className="flex items-center justify-center flex-1 px-4">
          <p className="text-base text-neutral-700 dark:text-neutral-300 italic text-center">
            "{getCurrentQuote()}"
          </p>
        </div>
      </div>
