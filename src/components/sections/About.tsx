      ...
      <div className='flex items-center gap-7 w-full flex-col sm:flex-row'>
        <div className='relative aspect-square w-32 sm:w-40 overflow-hidden rounded-full shrink-0'>
          <div
            ...
            style={{
              background: `url(/img/photo_2024-05-05_20-24-39.jpg) center/cover no-repeat`,
              opacity: 0.5,
          ...
          {!imageError ? (
            <Image
              src='/img/photo_2024-05-05_20-24-39.jpg'
              alt='avatar'
              fill
              className={`object-cover relative z-10 transition-opacity duration-500 hover:scale-110 ${
            ...
            <div className='absolute inset-0 flex items-center justify-center bg-neutral-200 dark:bg-neutral-800 rounded-full'>
              <User className='w-12 h-12 text-neutral-400 dark:text-neutral-600' />
            </div>
          )}
          {!imageLoaded && !imageError && (
            <div className='absolute inset-0 flex items-center justify-center bg-neutral-200 dark:bg-neutral-800 rounded-full animate-pulse'>
              <div className='w-8 h-8 border-2 border-neutral-400 dark:border-neutral-600 border-t-transparent rounded-full animate-spin' />
            </div>
          )}
        </div>
