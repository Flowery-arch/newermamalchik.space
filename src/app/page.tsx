...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-[#0a0a0a] flex flex-col relative overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          ...
          {!showTetris && (
            <motion.div
              ...
              className="w-full flex flex-col flex-grow py-4 sm:py-6 md:py-8 lg:py-12 items-start md:items-center"
            >
              <div 
      ...
      <footer className="w-full py-3 sm:py-4 text-center text-xs sm:text-sm text-neutral-500 dark:text-neutral-600 mt-auto absolute bottom-0 left-0 right-0">
        {t('footer.copyright')}
      </footer>
    </main>
  );
