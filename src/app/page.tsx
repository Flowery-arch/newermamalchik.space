    ...
    <main className="min-h-screen bg-white dark:bg-[#0a0a0a] flex flex-col relative">
      ...
      {!isLoading && (
        ...
        <motion.div
          ...
          className="flex flex-col flex-grow py-6 sm:py-8 md:py-12 items-start md:items-center"
        >
          <div 
            className="mx-auto w-full max-w-[1600px] px-4 sm:px-6 md:px-8 lg:px-12 mt-4 sm:mt-8 md:mt-16"
            style={{ transform: `translateY(${parallaxOffset}px)` }}
          >
            <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr] gap-3 sm:gap-4 md:gap-6 lg:gap-8">
              {/* Left Column */}
