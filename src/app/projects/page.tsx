...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Инновационный Minecraft проект, выделяющийся уникальными функциями и современным веб-дизайном для захватывающего игрового опыта.',
  ...
  },
  {
    ...
    version: 'v4',
    url: 'https://neweramamalchik.space/',
    description: 'Бэкенд-система для проекта Flowery, разработанная на Bun и Elysia, управляющая пользовательскими данными, покупками и серверной логикой.',
    logo: 'https://images-ext-1.discordapp.net/external/rR0y_v-Ghc1rCpIt91lgqrbD5KL9Ba3c2jofWqIZ8XU/%3Fsize%3D1024/https/cdn.discordapp.com/icons/1144350058964336724/0a0c7ce9a2307601f5cfeb81ee8199fa.webp?format=webp&width=780&height=780',
    stack: {
      bun: 'v1.2',
      elysia: 'v1.2'
  ...
  },
  {
    ...
    description: 'Проект заброшен по просьбе правообладателя.',
    ...
    status: {
      ...
      text: 'Abandoned at copyright holder\'s request'
    },
    sourceCode: false,
    type: 'orders',
  ...
  },
  {
    ...
    version: 'v1',
    url: '#', // Замените на реальный URL, если есть
    description: 'Discord бот для проекта Flowery, разработанный с использованием Node.js и Discord.js для управления сервером и взаимодействия с пользователями.',
    logo: 'https://images-ext-1.discordapp.net/external/rR0y_v-Ghc1rCpIt91lgqrbD5KL9Ba3c2jofWqIZ8XU/%3Fsize%3D1024/https/cdn.discordapp.com/icons/1144350058964336724/0a0c7ce9a2307601f5cfeb81ee8199fa.webp?format=webp&width=780&height=780',
    stack: {
      next: 'v13.4.18',
      discordjs: 'v15.0.0',
